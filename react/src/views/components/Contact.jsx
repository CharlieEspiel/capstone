...
export function Contact() {
    ...
    return (
        <React.Fragment>
            <Button size="md" color="red" className="tracking-wide bg-white text-main w-full text-[16px] p-4 px-8 mt-2 rounded-xl whitespace-nowrap" onClick={openDrawer}>Contact Us</Button>
