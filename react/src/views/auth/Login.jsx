...
const LoginComponent = () => {
    return (
        <div className='max-w-lg mx-auto h-[300px] my-10 rounded-lg bg-blue-gray-700 p-5 py-10'>
            {/* Session Status */}
            {/* Note: The Laravel session('status') here can be managed using state in React if needed */}
